...
# Full updated fighters list with exact champions as requested:
# Том Аспиналл, Карлос Улберг, Шон Стрикланд, Ислам Махачев, Джастин Гейджи, Александр Волкановски, Петр Ян, Джошуа Ван

fighters_js_content = """const fighters = [
    ...
    // =========================================================================
    {
        ...
        nationality: "USA", flag: "🇺🇸",
        height: "6'1\" (185 cm)", reach: "76.0\" (193 cm)", stance: "Orthodox", age: 34,
    ...
    // =========================================================================
    {
        ...
        height: "5'6\" (168 cm)", reach: "71.5\" (182 cm)", stance: "Orthodox", age: 37,
...
with open(r"C:\Users\user\.gemini\antigravity\scratch\ufc-fighters-website\fighters.js", "w", encoding="utf-8") as f:
    f.write(fighters_js_content)

print("EXACT USER-SPECIFIED CHAMPIONS APPLIED SUCCESSFULLY!")
